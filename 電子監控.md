...
In the Council of Europe member (歐洲理事會成員)states, electronic monitoring is used in the following ways, as: 
...
- a condition related to dropping of charges, sentence, or the implementation of the sentence 與撤銷指控、判決或判決執行相關的條件(Council of Europe Annual Penal Statistic II, 2011).