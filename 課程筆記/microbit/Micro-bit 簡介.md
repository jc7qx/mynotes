BBC micro:bit 是一台袖珍型電腦，初階學生可以利用它瞭解軟體和硬體如何共同運作。 它有一組 LED 燈顯示器、按鍵、感測器和許多輸入/輸出功能，當編寫程式碼時，它可以與您和您的世界互動。學生可以藉由圖形化程式(MakeCode)或指令型程式語言(Python)來控制 micro:bit，藉以訓練學生的計算邏輯及培養撰寫程式能力。
